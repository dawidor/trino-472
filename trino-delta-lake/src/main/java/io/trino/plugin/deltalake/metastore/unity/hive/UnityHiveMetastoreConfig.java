...
import static io.trino.plugin.deltalake.metastore.unity.hive.UnityHiveMetastoreConfig.VersionCompatibility.NOT_SUPPORTED;

@DefunctConfig("hive.metastore.assume-canonical-partition-keys")
public class UnityHiveMetastoreConfig
{
    ...
    public UnityHiveMetastoreConfig setCatalogDirectory(String catalogDirectory)
    {
    ...
    @NotNull
    public UnityHiveMetastoreConfig.VersionCompatibility getVersionCompatibility()
    {
        return versionCompatibility;
    }

    @Config(VERSION_COMPATIBILITY_CONFIG)
    public UnityHiveMetastoreConfig setVersionCompatibility(UnityHiveMetastoreConfig.VersionCompatibility versionCompatibility)
    {
    ...
    public UnityHiveMetastoreConfig setDisableLocationChecks(boolean disableLocationChecks)
    {

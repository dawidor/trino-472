        ...
        implements DeltaLakeTableOperationsProvider
{
    ...
    @Inject
    public DeltaLakeUnityMetastoreTableOperationsProvider(HiveMetastoreFactory hiveMetastoreFactory)
    {
    ...
    {
        return new DeltaLakeUnityMetastoreTableOperations(hiveMetastoreFactory.createMetastore(Optional.of(session.getIdentity())));
    }
}
